...
import static com.securitymagick.AppConstants.adminSettingsSqlInjection;
...
public class AdminDao {
	...
	public void updateAdminDBItem(AdminDBItem adminDBItem) {
		...
		if (adminSettingsSqlInjection) {
			sql = "UPDATE admin SET adminSettingValue="+ adminDBItem.getSettingValue() + "  WHERE id =" + adminDBItem.getId();
		} else {
