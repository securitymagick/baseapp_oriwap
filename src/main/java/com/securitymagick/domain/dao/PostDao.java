...
import static com.securitymagick.AppConstants.postCommentSqlInjection;
...
public class PostDao {
	...
	public void addPost(Post p) {
		String sql = "INSERT INTO posts VALUES (:id,:" + TITLE + ",:imageName,:"+ AUTHOR + ",:description)";
		...
		public void addComment(PostComment pc) {
			String sql = "INSERT INTO comments VALUES (:id,:postId,'"+ pc.getComment() +"',:username)";
			...
			if (!postCommentSqlInjection) {
				sql = "INSERT INTO comments VALUES (:id,:postId,:comment,:username)";
