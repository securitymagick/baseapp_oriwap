...
import static com.securitymagick.AppConstants.userAgentSqlInjection;
...
public class LogDao {
	...
	public void addLog(LogMessage lm) {
		...
		mapSqlParameterSource.addValue("id", logId);
		String sql = "INSERT INTO logtable VALUES (:id,:useragent,:username,:message)";
		if (userAgentSqlInjection) {
			sql = "INSERT INTO logtable VALUES (:id, '" + lm.getUseragent() + "',:username,:message)";
		} else {
			mapSqlParameterSource.addValue("useragent", lm.getUseragent());
		}
